...
channel_id = -1001141611268	# id channel shoma
admins = [426950315,170146015]	# id admin (ha)
onlines = []
merchent = '4608362e-db42-11e7-af46-005056a205be'	# az tariq zarinpal eqdam be daryaft merchentid konid va inja qarar bedid
token = '514954192:AAFpbS_lQvv3L3ykkZAg7Kp6awMZBigVmsc'	#token
debug_mode = False
debug_user = 426950315	# id man hast , baraye daryaft error
#		Config|		#
